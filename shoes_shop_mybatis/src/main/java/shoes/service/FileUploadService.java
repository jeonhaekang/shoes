...
public class FileUploadService {
	...
	public String restore(MultipartFile multipartFile, String root,int category, String name, int num) {
		...
		try {
			...
			String savepath = ResourceUtils.getFile("classpath:static/image/"+ root + "/" + category).toPath().toString();
			...
			saveFileName = name + "_" + num + extName;
